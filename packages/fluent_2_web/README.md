...
<h1 align="center">fluent_2_web</h1>
...
<p align="center">
  <a href="https://pub.dev/packages/fluent_2_web"><img src="https://img.shields.io/pub/v/fluent_2_web?logo=dart&color=0F6CBD&label=pub" alt="pub version" /></a>
...
One import gets you components *and* tokens — `fluent_2_web` re-exports `fluent_2_core`.
...
| [`fluent_2_mobile`](https://pub.dev/packages/fluent_2_mobile) | Touch renderings of the same components. |
