...
void main() {
  test(
    'the corpus is present and carries every section the kernel needs',
    () async {
      ...
      final versions =
          (corpus['meta'] as Map<String, dynamic>)['versions']!
      ...
      for (final section in <String>[
        ...
        expect(
          ...
          isNotNull,
          reason:
              'section "$section" must exist — a missing section reads as a '
