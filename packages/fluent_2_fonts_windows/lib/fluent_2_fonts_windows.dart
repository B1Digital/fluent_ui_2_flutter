/// Windows-only Selawik assets and dynamic loader for Fluent 2.
library;

import 'package:flutter/services.dart';

/// Loads the open-source Selawik substitute used by Fluent Windows.
abstract final class FluentWindowsFonts {
  /// Font family registered with the Flutter engine.
  static const String family = 'Selawik';

  /// Package containing the Windows assets.
  static const String package = 'fluent_2_fonts_windows';
