...
// arrives through `package:fluent_2/fluent_2.dart`, so a missing export
...
// above the charts block in `lib/fluent_2.dart`, and
  ...
  test('every axis symbol is reachable from the package barrel', () {
    ...
    expect(
      ...
      reason:
          ...
          'in lib/fluent_2.dart, alphabetically ordered inside the charts '
          'block.',
    );
  });
