...
Checked-in usage excerpt from `packages/fluent_2/example/lib/stories/carousel_stories.dart`:
...
- Stories: `packages/fluent_2/example/lib/stories/carousel_stories.dart`
